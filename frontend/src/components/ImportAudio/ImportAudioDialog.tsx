            ...
            <>
              {fileInfo ? (
                <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground00 mt-1">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-foreground00">Meeting Title</label>
                    <Input
                      value={title}
                      onChange={(e) => {
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  <FileAudio className="h-12 w-12 text-muted-foreground00 mx-auto mb-4" />
                  ...
                  <p className="text-sm text-muted-foreground00 mt-2">MP4, WAV, MP3, FLAC, OGG, MKV, WebM, WMA</p>
                </div>
              )}
