  ...
  return (
    <div
      className={cn(
        ...
        isAuthorized ? 'border-foreground bg-muted' : isDenied ? 'border-red-300 bg-red-500/10' : 'bg-card border-border'
      )}
    >
      {/* Left side: Icon + Info */}
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div
          className={cn(
            ...
            isAuthorized ? 'bg-secondary' : isDenied ? 'bg-red-500/20' : 'bg-muted'
          )}
        >
